# Powerbase `gotrue-js` example

## Setup

### With a Powerbase project
...
You can find a docker compose file for spinning up a [Gotrue server](https://github.com/skorpland/gotrue) in the [infra folder](../infra).
